...
bool
RenderTarget::Create(ID3D11Device* device, DXGI_FORMAT format, 
...
bool
RenderTarget::CreateRenderTargetViews(ID3D11Device* device, DXGI_FORMAT format, unsigned int mipLevels, unsigned int numSubSamples)
{
...
void
RenderTarget::Clear(ID3D11DeviceContext* deviceContext, const float color[4]) const
{
