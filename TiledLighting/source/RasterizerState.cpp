...
bool
RasterizerState::Create(ID3D11Device* device, const D3D11_RASTERIZER_DESC& desc)
{
...
bool
RasterizerState::Create(ID3D11Device* device, D3D11_FILL_MODE fillMode, D3D11_CULL_MODE cullMode,
